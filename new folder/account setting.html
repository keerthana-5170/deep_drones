...
<html>
    <head>
        ...
        <script src="https://kit.fontawesome.com/992e697e7d.js" crossorigin="anonymous"></script>
         <link rel="stylesheet" href="account seting.css">
         <link href="vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    </head>
    <body>
      <div class="container">
        <div class="request-estimate-close" style="display: block;"><a href="../shop.html" style="position: absolute;right: 20px;"><i class="fas fa-times" ></i></a></div>
        
<div class="row justify-content-center">
    <div class="col-12 col-lg-10 col-xl-8 mx-auto"style="margin-top:75px">
